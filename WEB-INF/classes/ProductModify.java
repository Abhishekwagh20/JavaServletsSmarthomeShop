	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Add Product"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='smartspeaker' selected>SmartSpeaker</option><option value='smartdoorbells'>SmartDoorbell</option><option value='smartdoorlocks'>SmartDoorlock</option><option value='smartlightings'>SmartLighting</option></select>"
					+ "</td></tr><tr><td>"
