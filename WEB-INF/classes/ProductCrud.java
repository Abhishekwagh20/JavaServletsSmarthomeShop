...
public class ProductCrud extends HttpServlet {
	protected void doGet(HttpServletRequest request,
			...
			{
			  	if(producttype.equals("smartspeakers")){
				allsmartspeaker = MySqlDataStoreUtilities.getSmartspeakers();
				if(allsmartspeaker.containsKey(productId)){
				msg = "Product already available";
				System.out.print(productId);
				  }
					  
			  }else if(producttype.equals("smartdoorlocks"))
			  {
				  allsmartdoorlocks = MySqlDataStoreUtilities.getSmartdoorlocks();
				  if(allsmartdoorlocks.containsKey(productId)){
					  msg = "Product already available";
				  }
			  }else if (producttype.equals("smartdoorbells"))
			  {
				  allsmartdoorbells = MySqlDataStoreUtilities.getSmartDoorbells();
				  if(allsmartdoorbells.containsKey(productId)){
					  msg = "Product already available";
				  }
			  }else if (producttype.equals("smartlightings"))
			  {  
				  allsmartlightings = MySqlDataStoreUtilities.getSmartlightings();
				  if(allsmartlightings.containsKey(productId)){
					  msg = "Product already available";
				  }
			...
			}else if(action.equals("delete"))
			{
				  ...
				  if(allsmartspeaker.containsKey(productId)){
					  msg = "good";
					  System.out.print("smartspeakers");
				  }
