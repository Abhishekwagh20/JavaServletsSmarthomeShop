...
public class SmartSpeakerList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		All the SmartSpeaker and SmartSpeaker information are dispalyed in the Content Section
		...
		for(Map.Entry<String, SmartSpeaker> entry : hm.entrySet())
		{
			...
			pw.print("<li id='item'><img src='images/smartspeakers/"+SmartSpeaker.getImage()+"' alt='' style='width:150px;height:150px;'/></li>");
